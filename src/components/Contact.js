            ...
            >
              ...
              <div className="p-6 space-y-6">
                <div className="space-y-2">
                  <label htmlFor="name" className="block text-gray-300 font-mono">
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-slate-700 border border-gray-600 rounded-md px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-neon-blue"
                    placeholder="Your Name"
                  />
                </div>
                
                <div className="space-y-2">
                  <label htmlFor="email" className="block text-gray-300 font-mono">
                ...
                <div className="space-y-2">
                  <label htmlFor="message" className="block text-gray-300 font-mono">
...
{`const contactInfo = {
  ...
  response_time: "Within 24 hours"
            ...
            <motion.h3 
              variants={itemVariants}
              className="text-xl font-bold text-neon-blue font-mono mb-4"
            >
              Connect With Me
            </motion.h3>
            ...
            <div className="space-y-4">
              {socialLinks.map((link, index) => (
                <motion.a
                  ...
                  variants={itemVariants}
                  className="flex items-center gap-4 p-4 rounded-lg bg-slate-800 hover:bg-slate-700 transition-all group hover:translate-x-2"
                >
                  <div className="w-10 h-10 rounded-full bg-slate-700 flex items-center justify-center group-hover:bg-neon-blue/20 transition-colors">
